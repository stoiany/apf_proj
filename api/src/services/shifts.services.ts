import {
    ...
    createShiftRepo, deleteShiftRepo, getTop3ByTimeRepo, getTop3UsersByShiftCountRepo,
    readShiftByIdRepo,
    readShiftsRepo,
    updateShiftRepo
...
export async function getTop3ByTime(targetTimeDto : timeDto){
    const time = targetTimeDto.time;
    return await getTop3ByTimeRepo(time);
}